...
execute if entity @e[type=experience_orb,tag=fairy,tag=!claimed] as @e[type=experience_orb,tag=fairy,tag=!claimed] at @s if entity @p[distance=..1] as @p[distance=..1] if score @s fairy_count = @s fairy_count_max run tag @s add fairy_heal
execute if entity @e[type=experience_orb,tag=fairy,tag=!claimed] as @e[type=experience_orb,tag=fairy,tag=!claimed] at @s if entity @p[distance=..1] as @p[distance=..1] if score @s fairy_count < @s fairy_count_max run tag @s add fairy_add
execute if entity @e[type=experience_orb,tag=fairy,tag=!claimed] as @e[type=experience_orb,tag=fairy,tag=!claimed] at @s if entity @p[distance=..1] run tag @s add claimed
execute if entity @e[type=experience_orb,tag=fairy,tag=claimed] as @e[type=experience_orb,tag=fairy,tag=claimed] at @s if entity @p[distance=..1] at @p[distance=..1] run tp @s ~ ~ ~
