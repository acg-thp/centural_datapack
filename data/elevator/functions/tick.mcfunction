...
execute if entity @p[tag=elevator_up] as @a[tag=elevator_up] at @s align x align y align z unless entity @s[tag=elevator_up,dx=1,dy=1,dz=1] unless entity @e[tag=elevator_slab,distance=..3] run effect clear @s minecraft:levitation
