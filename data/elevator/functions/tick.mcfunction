...
execute if entity @e[tag=elevator,type=armor_stand] at @e[tag=elevator,type=armor_stand] align x align y align z positioned ~ ~2 ~ unless entity @p[dy=1,dx=1,dz=1,tag=!elevator_up] as @a[dy=1,dx=1,dz=1,tag=!elevator_up] run tag @s remove elevator_up 
