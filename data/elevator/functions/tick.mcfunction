...
execute if entity @p[tag=elevator_up] as @a[tag=elevator_up] at @s align x align y align z at @e[tag=elevator_slab.,dx=1,dy=1,dz=1] unless entity @s[tag=elevator_up,dx=1,dy=1,dz=1] run tag @s remove elevator_up
