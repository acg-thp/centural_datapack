...
execute if entity @e[tag=elevator,type=armor_stand] at @e[tag=elevator,type=armor_stand] at @e[tag=elevator_slab,distance=..1,limit=1] positioned ~ ~-1 ~ align x align y align z if entity @p[dx=1,dy=1,dz=1,tag=!elevator_up] as @a[dx=1,dy=1,dz=1,tag=!elevator_up] run tag @s add elevator_up 
...
execute if entity @e[tag=elevator_slab] as @e[tag=elevator_slab] at @s if entity @p[tag=elevator_up,distance=...5] run tp @a[tag=elevator_up,distance=...5] ~ ~.51 ~
execute if entity @e[tag=elevator_slab] as @e[tag=elevator_slab] at @s if entity @p[tag=elevator_up,distance=1..2] run tp @a[tag=elevator_up,distance=1..2] ~ ~.51 ~
