...
execute if entity @p[tag=elevator_up] as @a[tag=elevator_up] at @s align x align y align z unless entity @e[tag=elevator_slab,dx=1,dy=1,dz=1] run function music:as_the_world_falls_down/stop
execute if entity @p[tag=elevator_up] as @a[tag=elevator_up] at @s align x align y align z unless entity @e[tag=elevator_slab,distance=..1] run tag @s remove elevator_up
#execute if entity @p[tag=elevator_up] as @a[tag=elevator_up] at @s align x align y align z unless entity @e[tag=elevator_slab,dx=1,dy=1,dz=1] run effect clear @s minecraft:levitation

execute if entity @p[tag=elevator_up] as @a[tag=elevator_up] at @s positioned ~ ~2 ~ align x align y align z if entity @e[tag=elevator,tag=!elevator_slab,dx=1,dy=1,dz=1] at @e[tag=elevator_slab,dx=1,dy=1,dz=1] positioned ~ ~2 ~ run tp @s ~ ~ ~
