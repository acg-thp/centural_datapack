...
execute if entity @p[tag=elevator_up] as @a[tag=elevator_up] at @s align x align y align z unless entity @e[tag=elevator_slab,distance=..1] run function music:as_the_world_falls_down/stop
