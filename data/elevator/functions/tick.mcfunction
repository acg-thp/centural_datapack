...
execute if entity @e[tag=elevaor_slab] as @e[tag=elevator_slab] at @s if entity @p[tag=elevator_up,distance=...5] run say test1
execute if entity @e[tag=elevaor_slab] as @e[tag=elevator_slab] at @s if entity @p[tag=elevator_up,distance=1..2] run say test2
