...
execute if entity @e[tag=elevaor_slab] as @e[tag=elevator_slab] at @s if entity @p[tag=elevator_up,distance=...5] run tp @a[tag=elevator_up,distance=...5] ~ ~.5 ~
execute if entity @e[tag=elevaor_slab] as @e[tag=elevator_slab] at @s if entity @p[tag=elevator_up,distance=1..1.5] run tp @a[tag=elevator_up,distance=1..1.5] ~ ~.5 ~
