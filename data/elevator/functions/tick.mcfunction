...
execute if entity @e[tag=elevator_slab] as @e[tag=elevator_slab] at @s if entity @p[tag=elevator_up,distance=...5] run tp @a[tag=elevator_up,distance=...5] ~ ~1 ~
execute if entity @e[tag=elevator_slab] as @e[tag=elevator_slab] at @s if entity @p[tag=elevator_up,distance=1..2] run tp @a[tag=elevator_up,distance=1..2] ~ ~1 ~
