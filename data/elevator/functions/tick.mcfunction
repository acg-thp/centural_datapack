...
execute if entity @e[tag=elevator_slab] as @e[tag=elevator_slab] at @s align x align y align z positioned ~ ~-.25 ~ if entity @p[dx=1,dy=1,dz=1] as @p[dx=1,dy=1,dz=1] run tp @s ~ ~2 ~
