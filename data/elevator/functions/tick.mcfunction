...
execute if entity @p[tag=elevator_up] as @a[tag=elevator_up] at @s positioned ~ ~ ~ align x align y align z if entity @e[dx=1,dy=1,dz=1,tag=elevator_slab] at @e[dx=1,dy=1,dz=1,tag=elevator_slab] run tp @s ~ ~1.25 ~
