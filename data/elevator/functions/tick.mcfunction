...
execute if entity @p[tag=elevator_up] as @a[tag=elevator_up] at @s ancored feet positioned ~ ~1 ~ if entity @e[distance=..0.5,tag=elevator_slab] at @e[distance=..0.5,tag=elevator_slab] run tp @s ~ ~1.25 ~
