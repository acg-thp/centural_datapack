...
execute if entity @p[tag=elevator_up] as @a[tag=elevator_up] at @s align x align y align z positioned ~ ~ ~ if entity @e[tag=elevator,tag=!elevator_slab,dx=1,dy=1,dz=1] at @e[tag=elevator_slab,dx=1,dy=1,dz=1] positioned ~ ~1 ~ run tp @s ~ ~ ~
