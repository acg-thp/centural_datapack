execute if entity @e[tag=elevator,type=armor_stand] at @e[tag=elevator,type=armor_stand] at @e[tag=elevator_slab,distance=..1,limit=1] align x align y align z run particle minecraft:damage_indicator ~ ~ ~ 0 0 0 1 1 force @a[distance=..16]
