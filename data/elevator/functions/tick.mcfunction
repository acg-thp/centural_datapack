...
execute if entity @p[tag=elevator_up] as @a[tag=elevator_up] at @s at @e[tag=elevator_slab,distance=..1] align x align y align z unless entity @s[dx=1,dy=1,dz=1] run effect clear @s minecraft:levitation
execute if entity @p[tag=elevator_up] as @a[tag=elevator_up] at @s at @e[tag=elevator_slab,distance=..1] align x align y align z unless entity @s[dx=1,dy=1,dz=1] run tag @s remove elevator_up
