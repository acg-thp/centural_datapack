...
execute if entity @p[tag=quest_spacecraft_waldobe_dialouge_part_one] as @p[tag=quest_spacecraft_waldobe_dialouge_part_one] positioned as @s run tellraw @s "Hey, you there! I need your help!"
...
execute if entity @p[tag=quest_spacecraft_waldobe_dialouge_part_one,tag=quest_spacecraft_waldobe_dialouge_part_two] as @p[tag=quest_spacecraft_waldobe_dialouge_part_one,tag=quest_spacecraft_waldobe_dialouge_part_two] run tag @s add quest_spacecraft_waldobe_dialouge_part_one
