...
execute at @a positioned ~ -767 ~ as @a[dy=512,tag=in_void] run tag @s remove in_void
execute at @a positioned ~ -767 ~ as @a[dy=512,tag=!in_underworld] run tellraw @a "Welcome to the Underworld"
execute at @a positioned ~ -767 ~ as @a[dy=512,tag=!in_underworld] run tag @s add in_underworld
