...
execute if entity @p[tag=warp_underworld,scores={temporary_timer=150..}] as @a[tag=warp_underworld,scores={temporary_timer=0..50}] at @s run particle minecraft:falling_obsidian_tear ~ ~2 ~ 1 0 1 1 6 force @a[distance=..16]
execute if entity @p[tag=warp_underworld,scores={temporary_timer=150..}] as @a[tag=warp_underworld,scores={temporary_timer=50..100}] at @s run particle minecraft:portal ~ ~2 ~ 1 0 1 1 6 force @a[distance=..16]
...
execute if entity @p[tag=warp_underworld,scores={temporary_timer=150..}] as @a[tag=warp_underworld,scores={temporary_timer=1}] at @s run playsound minecraft:block.portal.ambient ambient @s ~ ~ ~ 16 1
execute if entity @p[tag=warp_underworld,scores={temporary_timer=150..}] as @a[tag=warp_underworld,scores={temporary_timer=50}] at @s run playsound minecraft:block.portal.trigger ambient @s ~ ~ ~ 16 1
