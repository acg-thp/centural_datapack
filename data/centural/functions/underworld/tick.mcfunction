...
execute if entity @e[tag=air] at @e[tag=air] run particle minecraft:sweep_attack ~ ~ ~ 0 0 0 1 1
...
execute if entity @e[tag=torture] at @e[tag=torture] run particle minecraft:lava ~ ~ ~ 0 0 0 1 1
